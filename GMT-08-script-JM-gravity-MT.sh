...
img2grd grav_27.1.img -R120/160/0/30 -Ggrav.grd -T1 -I1 -E -S0.1 -V
...
gmt grdimage grav.grd -I+a45+nt1 -R120/160/0/30 -JM6i -Cgrav.cpt -P -K > $ps
# Step-6. Add basemap: grid, title, costline
gmt pscoast -R -J -P \
	-V -W0.25p \
    -Df -B+t"Marine free-air gravity anomaly for the Mariana Trench area" \
	-Bxa4g3f2 -Bya4g3f2 \
    -O -K >> $ps
# Step-7. Add scale bar, directional rose
gmt psbasemap -R -J \
...
gmt psscale -R -J -Cgrav.cpt \
    -Dg114/0+w12.0c/0.5c+v+o0.5/0i+ml  \
    --FONT_LABEL=7p,Helvetica,dimgray \
    --FONT_ANNOT_PRIMARY=7p,Helvetica,dimgray \
    --MAP_ANNOT_OFFSET=0.1c \
    --MAP_LABEL_OFFSET=0.1c \
